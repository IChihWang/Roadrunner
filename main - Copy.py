        ...
        while traci.simulation.getMinExpectedNumber() > 0:
            ...
            for car_id in car_dst_dict:
                if car_id not in all_c:
                    ...
                    if car_id in car_intersection_id_dict:
                ...
                if len(data) > 0:
                    ...
                    for car_data in cars_data_list:
                        ...
                        if len(route_str)>0:
                            ...
                            if car_id in car_path_dict:
                                for key, value in node_turn_dict.items():
                                    if key not in car_path_dict[car_id]:
                                        print("Path change: new key")
                                    else:
                                        if value != car_path_dict[car_id][key]:
                                            print("Path change: ", car_id, key, value, car_path_dict[car_id][key])
...
if __name__ == "__main__":
    ...
    generate_routefile_with_src_dst(cfg.INTER_SIZE, float(arrival_rate), seed, 1800)
